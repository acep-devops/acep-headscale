...
property :v4_ip_prefixes, Array, default: ['100.64.0.0/10']
property :v6_ip_prefixes, Array, default: []
...
action :create do
  ...
  config = {
    ...
    'v4_ip_prefixes' => new_resource.v4_ip_prefixes,
    'v6_ip_prefixes' => new_resource.v6_ip_prefixes,
